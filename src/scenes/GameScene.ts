export class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    const players = {
      player1: this.physics.add.sprite(width*0.3,  height/2, 'player-harry').setScale(0.3),
      player2: this.physics.add.sprite(width*0.6, height/2, 'player-ron').setScale(0.3),
    };
